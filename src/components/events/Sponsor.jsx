...
const Sponsor = () => {
  ...
  return (
    <section className="border-silver border-t-2">
      {error && <Error />}
      {loading && <Loader />}
      <div className="md:container pt-20">
        {data && (
          <div key={data._id} className="md:flex ">
            ...
            <div className="flex items-center justify-center my-20 overflow-hidden">
                      ...
                      .map((s) => (
                        <li key={s._id} className="mx-2 text-xl font-bold">
                          <figure className="">
                            <img
                              src={
                                "http://localhost:5888/images/sponsor/" + s.logo
                              }
                              alt={s.sponsor}
                              className="grayscale w-40"
                            />
                          </figure>
                        </li>
                      ))}
